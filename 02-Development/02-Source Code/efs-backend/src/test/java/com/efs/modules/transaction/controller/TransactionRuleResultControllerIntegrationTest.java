...
class TransactionRuleResultControllerIntegrationTest {
    ...
    void shouldReturnForbiddenWhenReadingWithoutTransactionView()
        ...
        UUID ruleResultId =
                UUID.fromString(
                        created.get("ruleResultId").asText()
                );
    ...
    @Test
    void shouldHideCrossOrganizationRuleResultById()
            throws Exception {
    ...
    @Test
    void shouldHideCrossOrganizationRuleResultList()
            throws Exception {
    ...
    @Test
    void shouldHideCrossOrganizationRuleResultCreate()
            throws Exception {
    ...
    @Test
    void shouldFilterCrossOrganizationRuleResultGlobalQueries()
            throws Exception {
